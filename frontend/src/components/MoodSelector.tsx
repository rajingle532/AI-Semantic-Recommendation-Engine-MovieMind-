...
import { Smile, Flame, CloudRain, Search } from 'lucide-react';
import styles from './MoodSelector.module.css';

const moods = [
  { id: 'joy', label: 'Joy', icon: Smile, color: '#FFD700' },
  { id: 'thrill', label: 'Thrill', icon: Flame, color: '#FF4500' },
  { id: 'sorrow', label: 'Sorrow', icon: CloudRain, color: '#1E90FF' },
  { id: 'mystery', label: 'Mystery', icon: Search, color: '#9370DB' },
];
      ...
      <div className={styles.moodList}>
        {moods.map((mood) => {
          ...
          return (
            ...
            >
              <span className={styles.emoji}><Icon size={18} /></span>
